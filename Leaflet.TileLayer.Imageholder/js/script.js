...
let placeholderTileLayer1 = L.tileLayer.imageholder(placeholderTile_1_Options);
let placeholderTileLayer2 = L.tileLayer.imageholder(placeholderTile_2_Options);

let baseLayers = {
    "Imageholder 1": placeholderTileLayer1,
    "Imageholder 2": placeholderTileLayer2
};
